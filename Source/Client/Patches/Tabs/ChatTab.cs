...
namespace GameClient
{
    public class ChatTab : MainTabWindow
    {
        ...
        {
            string toShow = PlayerRecountManager.currentPlayers > 1 ? "RTChatOnlinePlayers".Translate(PlayerRecountManager.currentPlayers) : "RTChatOnlinePlayer".Translate(PlayerRecountManager.currentPlayers) ;
