    ...
    public static class PlanetManager
    {
        ...
        public static void SpawnSingleSite(SiteData siteData)
        {
            if (ClientValues.isReadyToPlay)
            {
                ...
                catch (Exception e) { Logger.WriteToConsole($"Failed to spawn site at {siteData.tile}. Reason: {e}", LogMode.Error); }
            }
        }
        ...
        public static void RemoveSingleSite(SiteData siteData)
        {
            if (ClientValues.isReadyToPlay)
            {
                ...
                catch (Exception e) { Logger.WriteToConsole($"Failed to remove site at {siteData.tile}. Reason: {e}", LogMode.Error); }
            }
        }
    }
