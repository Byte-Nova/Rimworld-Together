...
namespace GameClient
{
    public class RT_Dialog_2Button : Window
    {
        ...
        public override void DoWindowContents(Rect rect)
        {
            ...
            if (Widgets.ButtonText(new Rect(new Vector2(centeredX - buttonX / 2 + buttonX * 0.125f, rect.yMax - buttonY), new Vector2(buttonX * 0.75f, buttonY)), "RimworldTogether.Cancel".Translate()))
            {
