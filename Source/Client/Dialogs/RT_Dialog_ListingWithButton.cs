...
namespace GameClient
{
    public class RT_Dialog_ListingWithButton : Window
    {
        ...
        public override void DoWindowContents(Rect rect)
        {
            ...
            if (Widgets.ButtonText(new Rect(new Vector2(centeredX - buttonX / 2, rect.yMax - buttonY), new Vector2(buttonX, buttonY)), "RimworldTogether.Close".Translate()))
            {
        ...
        private void DrawCustomRow(Rect rect, string element, int index)
        {
            ...
            if (Widgets.ButtonText(new Rect(new Vector2(rect.xMax - selectButtonX, rect.yMax - selectButtonY), new Vector2(selectButtonX, selectButtonY)), "RimworldTogether.Select".Translate()))
            {
