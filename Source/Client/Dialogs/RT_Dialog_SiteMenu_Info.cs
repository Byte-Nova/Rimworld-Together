...
namespace GameClient
{
    public class RT_Dialog_SiteMenu_Info : Window 
    {
        ...
        public override void DoWindowContents(Rect mainRect)
        {
            ...
            num += heightDesc;
            Widgets.Label(new Rect(viewRightColumn.x, num, viewRightColumn.width, 20f), ("RTSiteMenuCost".Translate()));
            num += 20f;
            ...
            Text.Font = GameFont.Small;
            Widgets.Label(new Rect(viewRightColumn.x, num, viewRightColumn.width, 20f), "RTSiteMenuTimeInterval".Translate());
            num += 20f;
            ...
            if (Widgets.ButtonText(new Rect(rightColumn.x + 5f, rightColumn.yMax, rightColumn.width - 10f, 40f), "RTSiteMenuBuy".Translate()))
            {
